			...
			_ = function(e) {
				...
				return a(t, e), c(t, [{
					...
					value: function(e) {
						...
						var n = window.__vConsole_cmd_result,
							l = window.__vConsole_cmd_error;
				...
				return a(t, e), c(t, [{
					...
					value: function(e, t) {
						...
						if (this.reqList[e] = n, this.isReady) {
							...
							var a = d["default"].render(_["default"], i),
								c = this.domList[e];
						...
						if (e) {
							...
							t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function() {
								...
								return e.onreadystatechange = function() {
									var o = t.reqList[r] || {};
									if (o.readyState = e.readyState, o.status = e.status, o.responseType = e.responseType, 0 == e.readyState) o.startTime = +new Date;
