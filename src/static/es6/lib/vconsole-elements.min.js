 ...
 */
! function(e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports["vConsole-elements"] = t() : e["vConsole-elements"] = t()
}(this, function() {
	return function(e) {
		function t(o) {
		...
		var s = n(5),
			...
			u = o(d),
			v = vConsole.$,
			f = (vConsole.tool, function(e) {
				function t() {
					var e;
					r(this, t);
					for (var n = arguments.length, o = Array(n), i = 0; i < n; i++) o[i] = arguments[i];
					var l = a(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(o))),
						s = l;
					s.node = {}, s.$tabbox = v.render(c["default"], {}), s.nodes = [], s.activedElem = {};
					var d = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver;
					return s.observer = new d(function(e) {
				...
				return i(t, e), l(t, [{
					...
					value: function(e) {
						var t = this,
							n = [{
								...
								onClick: function(e) {
									if (t.activedElem)
										if (v.hasClass(t.activedElem, "vc-toggle"))
											for (var n = 0; n < t.activedElem.childNodes.length; n++) {
												var o = t.activedElem.childNodes[n];
												if (v.hasClass(o, "vcelm-l") && !v.hasClass(o, "vcelm-noc") && !v.hasClass(o, "vc-toggle")) {
													v.one(".vcelm-node", o).click();
													break
												}
											} else v.one(".vcelm-node", t.activedElem).click()
								}
							}, {
								name: "Collapse",
								global: !1,
								onClick: function(e) {
									t.activedElem && (v.hasClass(t.activedElem, "vc-toggle") ? v.one(".vcelm-node", t.activedElem).click() : t.activedElem.parentNode && v.hasClass(t.activedElem.parentNode, "vcelm-l") && v.one(".vcelm-node", t.activedElem.parentNode).click())
								}
							}];
						e(n)
					}
					...
					value: function() {
						...
						var e = this.renderView(this.node, v.one(".vc-log", this.$tabbox)),
							t = v.one(".vcelm-node", e);
						t && t.click();
						var n = {
							attributes: !0,
							childList: !0,
						...
						this.observer.observe(document.documentElement, n)
					}
				}, {
					key: "onRemove",
					value: function() {
					...
					value: function(e) {
						var t = e.target,
							n = t.__vconsole_node;
						if (n) {
							this.getNode(t), n.view && v.removeClass(n.view, "vcelm-noc");
							for (var o = 0; o < e.addedNodes.length; o++) {
								...
								if (a)
									if (null !== e.nextSibling) {
										...
										i.view && this.renderView(a, i.view, "insertBefore")
					...
					value: function(e, t, n) {
						var o = this,
							r = new u["default"](e).get();
						switch (e.view = r, v.delegate(r, "click", ".vcelm-node", function(t) {
							t.stopPropagation();
							var n = this.parentNode;
							if (!v.hasClass(n, "vcelm-noc")) {
								o.activedElem = n, v.hasClass(n, "vc-toggle") ? v.removeClass(n, "vc-toggle") : v.addClass(n, "vc-toggle");
								for (var r = -1, a = 0; a < n.children.length; a++) {
									var i = n.children[a];
									v.hasClass(i, "vcelm-l") && (r++, i.children.length > 0 || (e.childNodes[r] ? o.renderView(e.childNodes[r], i, "replace") : i.style.display = "none"))
								}
							}
						}), n) {
							case "replace":
		...
		function o(e, t) {
			for (var n = 0; n < e.length; n++) {
				...
				if (r) {
					...
					for (; a < o.parts.length; a++) r.parts.push(c(o.parts[a], t))
				} else {
					for (var i = [], a = 0; a < o.parts.length; a++) i.push(c(o.parts[a], t));
					f[o.id] = {
						id: o.id,
						refs: 1,
						parts: i
		...
		function c(e, t) {
			...
			if (t.singleton) {
				var a = b++;
				n = g || (g = l(t)), o = d.bind(null, n, a, !1), r = d.bind(null, n, a, !0)
			} else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = s(t), o = v.bind(null, n), r = function() {
				i(n), n.href && URL.revokeObjectURL(n.href)
			}) : (n = l(t), o = u.bind(null, n), r = function() {
				i(n)
			});
			return o(e),
				function(t) {
		...
		var s = function() {
			...
			v = o(u),
			f = vConsole.$,
			p = (vConsole.tool, function() {
				function e(t) {
					r(this, e), this.node = t, this.view = this._create(this.node)
				}
				return s(e, [{
					key: "get",
					value: function() {
					...
					value: function(e, t) {
						...
						switch (f.addClass(n, "vcelm-l"), e.nodeType) {
							case n.ELEMENT_NODE:
					...
					key: "_createTextNode",
					value: function(e, t) {
						f.addClass(t, "vcelm-t vcelm-noc"), e.textContent && t.appendChild(i(l(e.textContent)))
					}
				}, {
					...
					value: function(e, t) {
						var n = a(e.tagName),
							o = n;
						0 == e.childNodes.length && (o = !0);
						var r = f.render(d["default"], {
								node: e
							}),
							i = f.render(v["default"], {
								node: e
							});
						if (o) f.addClass(t, "vcelm-noc"), t.appendChild(r), n || t.appendChild(i);
						else {
							t.appendChild(r);
							for (var l = 0; l < e.childNodes.length; l++) {
								var s = document.createElement("DIV");
								f.addClass(s, "vcelm-l"), t.appendChild(s)
							}
							n || t.appendChild(i)
						}
					}
		...
		e.exports = "<span class=vcelm-node>&lt;{{node.tagName.toLowerCase()}}{{if (node.className || node.attributes.length)}} <i class=vcelm-k> {{for (var i=0; i<node.attributes.length; i++)}} {{if (node.attributes[i].value !== '')}} {{node.attributes[i].name}}=\"<i class=vcelm-v>{{node.attributes[i].value}}</i>\"{{else}} {{node.attributes[i].name}}{{/if}}{{/for}}</i>{{/if}}&gt;</span>"
	}, function(e, t) {
