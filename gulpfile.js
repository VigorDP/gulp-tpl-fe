...
gulp.task('build', function(cb) { //默认不放 CDN
	...
	runSequence(['svg'], ['eslint', 'ES6', 'fileInclude'], ['sass'], ['imgMin'], ['usemin'], ['cssmin', 'jsmin', 'htmlmin'], ['revision'], ['cdnPre'], ['delRedundant'], ['zip'], function() {
...
gulp.task('dev', function(cb) {
	...
	runSequence(['svg'], ['fileInclude', 'eslint', 'ES6'], ['sass'], ['imgMin'], ['dev-server'], cb);
});